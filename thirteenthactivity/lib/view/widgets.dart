...
class _DataTableWidgetState extends State<DataTableWidget> {
  ...
  List get filteredJsonObjects {
    if (searchQuery.isEmpty) {
      return widget.jsonObjects;
    } else {
      return widget.jsonObjects.where((obj) {
        return widget.propertyNames.any((propName) =>
            obj[propName]
                .toString()
                .toLowerCase()
              ...
              .map(
                (name) => DataColumn(
                  onSort: (columnIndex, ascending) =>
                    ...
                    widget.propertyNames[columnIndex],
                    columnIndex,
